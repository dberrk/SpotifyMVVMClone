...
class HomeViewController: UIViewController {
    ...
    private static func createSectionLayout(section: Int) -> NSCollectionLayoutSection {
        ...
        case 1:   // Vertical group in horizontal group
            ...
            let horizontalGroup = NSCollectionLayoutGroup.horizontal(layoutSize: NSCollectionLayoutSize(widthDimension:                                                                                                   .fractionalHeight(1),
                                                                                                    heightDimension: .absolute(250)),
                                                                                                    subitem: item,
                                                                                                    count: 3)
            ...
            return section
        case 2 :   // Vertical group in horizontal group
            let item = NSCollectionLayoutItem(layoutSize: NSCollectionLayoutSize(
                                              widthDimension: .fractionalWidth(1.0),
                                               heightDimension: .fractionalHeight(1))
            )
